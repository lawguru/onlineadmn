...
<a href="index.php"> <img src="img/labor.png" style=" height:160;" /> </a>
<title>LCEA Admission</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse dropdown" id="myNavbar">
      <ul class="nav navbar-nav vertical" style="text-decoration:none;">
        <li>
          <a class="l-3-c" href="index.php" style="color: white !important;">LCEA Admissions</a></li>
          <li>
